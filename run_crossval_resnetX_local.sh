...
do
   python3 main.py -FOLD_I $fold_index -KFOLDS 5 -model_backend resnet50 -train_batch 16
done


for fold_index in 0 1 2 3 4
do
   python3 main.py -FOLD_I $fold_index -KFOLDS 5 -model_backend resnet101
done


for fold_index in 0 1 2 3 4
do
   python3 main.py -FOLD_I $fold_index -KFOLDS 5 -model_backend resnet34 -train_batch 16
done
